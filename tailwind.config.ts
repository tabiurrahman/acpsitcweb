	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'hero-gradient': 'linear-gradient(90deg, hsla(224.3, 76.3%, 48%, 0.9) 0%, hsla(277, 75%, 84%, 0.9) 100%)',
				'section-gradient': 'linear-gradient(90deg, rgba(10, 14, 23, 0.9) 0%, rgba(13, 27, 62, 0.9) 100%)',
			}
		}
	},
